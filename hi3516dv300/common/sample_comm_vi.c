...
HI_S32 SAMPLE_COMM_VI_GetSizeBySensor(SAMPLE_SNS_TYPE_E enMode, PIC_SIZE_E* penSize)
{
    ...
    switch (enMode)
    {
        case SONY_IMX327_MIPI_2M_30FPS_12BIT:
        case SONY_IMX327_MIPI_2M_30FPS_12BIT_WDR2TO1:
#ifdef __USE_KLB_RESOLUTION__   /* add [2021-04-18] */
            *penSize = KLB_RESOLUTION_1920x1080;
#else
            *penSize = PIC_1080P;
#endif
            break;
        ...
        case SONY_IMX415_MIPI_8M_20FPS_12BIT:
#ifdef __USE_KLB_RESOLUTION__   /* add [2021-04-18] */
            *penSize = KLB_RESOLUTION_3840x2160;
#else
        ...
        case OMNIVISION_OV12870_MIPI_1M_240FPS_10BIT:
#ifdef __USE_KLB_RESOLUTION__   /* add [2021-04-18] */
            *penSize = KLB_RESOLUTION_1280x720;
#else
            *penSize = PIC_720P;
#endif
            break;
        ...
        case OMNIVISION_OS04B10_MIPI_4M_30FPS_10BIT:
#ifdef __USE_KLB_RESOLUTION__   /* add [2021-04-18] */
            *penSize = KLB_RESOLUTION_2560x1440;
#else
            *penSize = PIC_2560x1440;
#endif
            break;
